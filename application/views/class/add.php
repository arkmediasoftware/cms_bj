<div class="col-lg-12">
  <div class="panel panel-primary">
    <div class="panel-heading">
      Add new class & communities
    </div>
  </div>
  <form class="form-horizontal" id="add_apartment" method="post" action="<?php echo site_url('class_communities/ajax/add') ?>">
...
$(document).ready(function(){
  ...
  $("#add_apartment").ajaxForm({
    success:function(data){
      window.location = "<?php echo site_url('class_communities') ?>";
    }
  });
